...
PHASES: list[Phase] = [
    ...
    Phase(
        ...
        panels=[
            ...
            DashboardPanel(name="Reconciliation queue", phase=2, status="live"),
            DashboardPanel(name="Daily refresh timeline", phase=2, status="live"),
    ...
    Phase(
        ...
        panels=[
            ...
            DashboardPanel(name="Constraint binding report", phase=3, status="live"),
        ],
    ),
    Phase(
        number=4,
    ...
    Phase(
        ...
        status="planned",
        panels=[
            DashboardPanel(name="Postgres migration status", phase=5, status="planned"),
            DashboardPanel(name="Job queue monitor", phase=5, status="planned"),
            DashboardPanel(name="Object store health", phase=5, status="planned"),
        ],
    ),
]
