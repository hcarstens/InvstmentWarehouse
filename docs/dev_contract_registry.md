                           ...
                           └─ pm2 (dashboard + registry)        [shipped]
                                └─ portfolio_analyst pa0–pa2     [shipped]
                                     └─ portfolio_optimization po0 [shipped — constrained MV QP, advisory]
                                          ...
                                          └─ po2/po3                [planned — robust stress, lot-discrete MIQP]
```
